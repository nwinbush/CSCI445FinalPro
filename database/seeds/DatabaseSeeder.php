...
class userTableSeeder extends Seeder
{
    public function run()
    {
        ...
        User::create(['id' => '1','name' => 'Mickey,Mouse', 'email' => 'mmouse@mines.edu', 'password' => bcrypt('123978')]);
...
class userDataTableSeeder extends Seeder
{
    public function run()
    {
        ...
        UserData::create(['id' => '5', 'name' => 'Bilbo,Baggins']);
        UserData::create(['id' => '6', 'name' => 'Winnie,Poohbear']);
        UserData::create(['id' => '7', 'name' => 'Daffy,Duck']);
        UserData::create(['id' => '8', 'name' => 'Wile,Coyote']);
        UserData::create(['id' => '9', 'name' => 'Road,Runner']);
        UserData::create(['id' => '10', 'name' => 'Marge,Simpson']);
        UserData::create(['id' => '11', 'name' => 'Charlie,Brown']);
        UserData::create(['id' => '12', 'name' => 'Lucy,VanPelt']);
        UserData::create(['id' => '13', 'name' => 'Bugs,Bunny']);
        UserData::create(['id' => '14', 'name' => 'Betty,Boop']);
        UserData::create(['id' => '15', 'name' => 'Lois,Griffin']);
        UserData::create(['id' => '16', 'name' => 'Wilma,Flintstone']);
        UserData::create(['id' => '17', 'name' => 'Fred,Flintstone']);
        UserData::create(['id' => '18', 'name' => 'Peppa,Pig']);
        UserData::create(['id' => '19', 'name' => 'Turanga,Leela']);
        UserData::create(['id' => '20', 'name' => 'Sylvester,Cat']);
        UserData::create(['id' => '21', 'name' => 'Felix,Cat']);
        UserData::create(['id' => '22', 'name' => 'Top,Cat']);
        UserData::create(['id' => '23', 'name' => 'Scooby,Doo']);
        UserData::create(['id' => '24', 'name' => 'Porky,Pig']);
        UserData::create(['id' => '25', 'name' => 'Garfield,Cat']);
        UserData::create(['id' => '26', 'name' => 'Peter,Pan']);
        UserData::create(['id' => '27', 'name' => 'Foghorn,Leghorn']);
        UserData::create(['id' => '28', 'name' => 'Manning, Peyton']);
        UserData::create(['id' => '29', 'name' => 'Green,Virgil']);
        UserData::create(['id' => '30', 'name' => 'Thomas, Julias']);
        UserData::create(['id' => '31', 'name' => 'Sanders, Emmanuel']);
        UserData::create(['id' => '32', 'name' => 'Tamme, Jason']);
        UserData::create(['id' => '33', 'name' => 'Knighton, Terrance']);
        UserData::create(['id' => '34', 'name' => 'Colquitt, Britton']);
        UserData::create(['id' => '35', 'name' => 'Roby, Bradley']);
        UserData::create(['id' => '36', 'name' => 'Ward, T.J.']);
        UserData::create(['id' => '37', 'name' => 'Ware, DeMarcus']);
        UserData::create(['id' => '38', 'name' => 'Webster, Kayvon']);
    }
}